...
// Таски:
// 1. разобраться с системой конфликтов - так то конфликт резолвер норм,
// но сука тяжело с ним, плюс он нужен для расрпостраннеых ошибок,
// лучше что-то простенькое вроде просто функций лямбд и чил
// 2. все таки я оставлю просто статические классы функторы,
// а там где будут конфликты это будут поля непосредственно так как...
// или можно сделать стат. сетер